...
open class ChartAxisValueDouble: ChartAxisValue {
    ...
    public init(_ double: Double, unit: String, formatter: NumberFormatter = ChartAxisValueDouble.defaultFormatter, labelSettings: ChartLabelSettings = ChartLabelSettings()) {
        self.formatter = formatter
        super.init(scalar: double, unit: unit, labelSettings: labelSettings)
    }

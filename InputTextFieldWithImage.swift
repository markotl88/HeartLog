...
class InputTextFieldWithImage: UIView {
    
    let kWidthConstraint : CGFloat = 280
    ...
    public func removeWarningPlaceholder(){
        if let temporaryPlaceholder = tempPlaceholder {
            placeLabel.textColor = UIColor.dmsCloudyBlueTwo
            placeLabel.text = temporaryPlaceholder //.uppercased()
    ...
    internal func setWarningPlaceholder(_ warning: String){
        ...
        if self.widthLabelConstraint.constant == 0 {
            if let temporaryPlaceholder = tempPlaceholder {
    ...
    fileprivate func updateTextConstraints() {
        ...
        let trailingTextViewConstraint = NSLayoutConstraint(item: textField, attribute: NSLayoutAttribute.trailing, relatedBy: NSLayoutRelation.equal, toItem: self, attribute: NSLayoutAttribute.trailing, multiplier: 1, constant: -60)
        ...
        let leadingBottomLineConstraint = NSLayoutConstraint(item: borderLine, attribute: NSLayoutAttribute.leading, relatedBy: NSLayoutRelation.equal, toItem: self, attribute: NSLayoutAttribute.leading, multiplier: 1, constant: 30)
        self.addConstraint(leadingBottomLineConstraint)
        
        let trailingBottomLineConstraint = NSLayoutConstraint(item: borderLine, attribute: NSLayoutAttribute.trailing, relatedBy: NSLayoutRelation.equal, toItem: self, attribute: NSLayoutAttribute.trailing, multiplier: 1, constant: -30)
...
extension InputTextFieldWithImage: UITextFieldDelegate{

...
class MaskInputTextField: UIView {
    
    var textField = SwiftMaskTextField()
    ...
    @IBInspectable var textFieldContent: String? = "" {
        didSet{
            ...
            if textFieldContent != "" {
                ...
                self.widthLabelConstraint.constant = 200
...
extension MaskInputTextField: UITextFieldDelegate{

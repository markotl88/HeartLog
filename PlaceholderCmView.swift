...
class PlaceholderCmView: UIView {
    ...
    fileprivate func commonInit() {
        ...
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(PlaceholderCmView.setFirstResponder))
...
extension PlaceholderCmView: UITextFieldDelegate{

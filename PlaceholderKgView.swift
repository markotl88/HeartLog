//
//  PlaceholderKgView.swift
//  FTN
//
//  Created by Marko Stajic on 1/27/17.
//  Copyright © 2017 DMS. All rights reserved.
//

import UIKit

class PlaceholderKgView: UIView {
    
    var textField = MaskPlaceholderTextField()
    fileprivate var placeLabel = UILabel()
    
    var widthLabelConstraint = NSLayoutConstraint()
    var labelWidthConstraint : CGFloat = 26
    ...
    fileprivate func commonInit() {
        ...
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(PlaceholderKgView.setFirstResponder))
...
extension PlaceholderKgView: UITextFieldDelegate{

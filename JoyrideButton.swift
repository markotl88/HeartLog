...
//  FTN
//
//  Created by Marko Stajic on 4/23/17.
//  Copyright © 2017 DMS. All rights reserved.
//

import UIKit

class JoyrideButton: UIButton {
    
    var selectedColor : UIColor? = UIColor.clear
    var enabledBackgroundColor : UIColor = UIColor.clear
    ...
    var higlightedBackgroundColor : UIColor = UIColor.clear

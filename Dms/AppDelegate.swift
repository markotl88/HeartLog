...
//        registerForPushNotification(application: application)
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "DmsModel", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = self.applicationDocumentsDirectory.appendingPathComponent("DmsModel 3.sqlite")
...
//            NSLog("Unresolved error \(wrappedError), \(wrappedError.userInfo)")
            print("Nije uspelo sta god da je radio")

//
//  GlucosePlaceholderView.swift
//  FTN
//
//  Created by Marko Stajic on 1/11/17.
//  Copyright © 2017 DMS. All rights reserved.
//

import UIKit

class GlucosePlaceholderView: UIView {
    var textField = MaskPlaceholderTextField()
    fileprivate var placeLabel = UILabel()
    
    var widthLabelConstraint = NSLayoutConstraint()
    var labelWidthConstraint : CGFloat = 62
    ...
    fileprivate func commonInit() {
        ...
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(PlaceholderView.setFirstResponder))
...
extension GlucosePlaceholderView: UITextFieldDelegate{
